...
<!--Vue du ou des profil(s) correspondant à la recherche pour suppression de la fiche base de données--> 
    ...
    <div class='smwp-card list-update-card'>
        ...
        <div class='smwp-directory-row'>
        	...
        	<input class='btn btn-danger btn-primary btn-delete' id='submit-show-data-member' type='submit' name='delete' value='SUPPRIMER LA FICHE'>
	     </div>
